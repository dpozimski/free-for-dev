...
## APIs, Data, and ML
  ...
  * [LinkMeta](https://linkmeta.dev) - Free URL metadata extraction API. Extract Open Graph tags, Twitter Cards, meta descriptions, and favicons from any URL. No API key required. Rate limited to 30 requests/minute.
  * [LinkShrink](https://linkshrink.dev) - Free privacy-first URL shortener API. Custom aliases, click analytics, QR codes, and password protection. No API key, no signup. Rate limited to 20 shortens/minute.
  ...
  * [OGForge](https://ogforge.dev) - Free Open Graph image generator API. Generate dynamic social media preview images with customizable templates. No API key required.
  ...
  * [PDFSpark](https://pdfspark.dev) - Free HTML/URL to PDF conversion API. Supports page formats, margins, watermarks, password protection, merge, split, and metadata extraction. Chromium rendering. No API key required. Rate limited to 20 requests/minute.
  ...
  * [QRMint](https://qrmint.dev) - Free styled QR code generator API. Custom colors, dot patterns, logos, WiFi/vCard/event types, batch generation up to 500. PNG and SVG up to 2048px. No API key required. Rate limited to 30 requests/minute.
...
## Web Hosting
  ...
  * [FreeKit](https://freekit.dev) - Free instant HTML hosting API. Upload HTML, CSS, and JS to get a live URL immediately. No API key required. Hosted on Azure Blob Storage with global CDN.
...
## Screenshot APIs
  ...
  * [PageShot](https://pageshot.site) - Free screenshot and webpage capture API. Capture full-page or viewport screenshots of any URL as PNG or JPEG. No API key required. Rate limited to 10 requests/minute.
